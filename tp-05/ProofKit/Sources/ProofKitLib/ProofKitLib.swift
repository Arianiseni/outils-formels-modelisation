...
public enum Formula {
    ...
    public var dnf: Formula {
		...
		// On va devoir transformer nos formules, car il faut passer par la "negative form" pour la DNF avec des AND
		// On cherche des minterms
		
		let Transformation = self.nnf
        ...
        case .conjunction(let c, let d):				
          ...
          case .disjunction(let C, let D):
              ...
              return (C.dnf && c.dnf).dnf || (D.dnf && c.dnf).dnf
          ...
          case .disjunction(let A, let B):
              ...
              return (A.dnf && d.dnf).dnf || (B.dnf && d.dnf).dnf			
    ...
    public var cnf: Formula {
		...
		// Ici, pas besoin de la "negative form". On transforme directement en CNF avec des OR
		// On cherche des maxterms
        ...
        case .conjunction(let a, let b):
          ...
          case .conjunction(let C, let D):
              ...
              return (C.cnf || c.cnf).cnf && (D.cnf || c.cnf).cnf
		...
		case .disjunction(let c, let d):
          ...
          case .conjunction(let A, let B):
            ...
            return (A.cnf || d.cnf).cnf && (B.cnf || d.cnf).cnf
